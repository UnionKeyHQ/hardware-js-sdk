...
export type MessageType = {
  ...
  EthereumSignTypedDataUnionKey: EthereumSignTypedDataOneKey;
  EthereumGnosisSafeTxRequest: EthereumGnosisSafeTxRequest;
  EthereumGnosisSafeTxAck: EthereumGnosisSafeTxAck;
  EthereumTypedDataStructRequestUnionKey: EthereumTypedDataStructRequestOneKey;
  EthereumStructMemberUnionKey: EthereumStructMemberOneKey;
  EthereumFieldTypeUnionKey: EthereumFieldTypeOneKey;
  EthereumTypedDataStructAckUnionKey: EthereumTypedDataStructAckOneKey;
  EthereumTypedDataValueRequestUnionKey: EthereumTypedDataValueRequestOneKey;
  EthereumTypedDataValueAckUnionKey: EthereumTypedDataValueAckOneKey;
  ...
  EthereumGetPublicKeyUnionKey: EthereumGetPublicKeyOneKey;
  EthereumPublicKeyUnionKey: EthereumPublicKeyOneKey;
  EthereumGetAddressUnionKey: EthereumGetAddressOneKey;
  EthereumAddressUnionKey: EthereumAddressOneKey;
  EthereumSignTxUnionKey: EthereumSignTxOneKey;
  EthereumAccessListUnionKey: EthereumAccessListOneKey;
  EthereumSignTxEIP1559UnionKey: EthereumSignTxEIP1559OneKey;
  EthereumAuthorizationSignature: EthereumAuthorizationSignature;
  EthereumAuthorizationUnionKey: EthereumAuthorizationOneKey;
  EthereumSignTxEIP7702UnionKey: EthereumSignTxEIP7702OneKey;
  EthereumTxRequestUnionKey: EthereumTxRequestOneKey;
  EthereumTxAckUnionKey: EthereumTxAckOneKey;
  EthereumSignMessageUnionKey: EthereumSignMessageOneKey;
  EthereumMessageSignatureUnionKey: EthereumMessageSignatureOneKey;
  EthereumVerifyMessageUnionKey: EthereumVerifyMessageOneKey;
  EthereumSignTypedHashUnionKey: EthereumSignTypedHashOneKey;
  EthereumTypedDataSignatureUnionKey: EthereumTypedDataSignatureOneKey;
