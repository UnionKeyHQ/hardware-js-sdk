...
const api: UnifiedMethodConfig[] = [
  {
    ...
    presets: [
      {
        title: 'Get address',
        description: 'Get a single Polkadot address',
        parameters: [
          {
            name: 'path',
            type: 'string',
          ...
          },
          {
            ...
            required: true,
            label: 'Network',
            description: 'Polkadot network name',
            value: 'polkadot',
          },
          {
            name: 'showOnOneKey',
      ...
      },
      {
        ...
        description: 'Get multiple Polkadot addresses',
        parameters: [
          {
            name: 'bundle',
            type: 'textarea',
  ...
  },
  {
    ...
    presets: [
      ...
      },
      {
        ...
        description: 'Sign a Kusama transaction (legacy format)',
        parameters: [
          {
            name: 'path',
            type: 'string',
          ...
          },
          {
            ...
            required: true,
            label: 'Network',
            description: 'Kusama network name',
            value: 'kusama',
          },
          {
            name: 'rawTx',
      ...
      },
      {
        ...
        description: 'Sign a Polkadot transaction (version 1001003)',
        parameters: [
          {
            name: 'path',
            type: 'string',
      ...
      },
      {
        ...
        description: 'Sign a Kusama transaction (version 1001003)',
        parameters: [
          {
            name: 'path',
            type: 'string',
          ...
          },
          {
            ...
            description: 'Hex-encoded raw transaction data',
            value:
              '040000950ca256090ba9a4cd520e1d891081207e112b1353bbe8da0cd8a910d684481a0284d71785010c0000164a0f001a000000b0a8d493285c2df73290dfb7e61f870f17b41801197a149ca93654499ea3dafe516ea5c74484d00abde1e84116ed965c55ed2c6b2b0bdffcfb7499460f05b6f100',
          },
        ],
      },
      {
        title: 'Sign Transaction astar (90)',
        description: 'Sign an Astar transaction',
        parameters: [
          {
            name: 'path',
            type: 'string',
          ...
          },
          {
            ...
            required: true,
            label: 'Network',
            description: 'Astar network name',
            value: 'astar',
          },
          {
            name: 'rawTx',
      ...
      },
      {
        ...
        description: 'Sign a Manta transaction',
        parameters: [
          {
            name: 'path',
            type: 'string',
          ...
          },
          {
            ...
            required: true,
            label: 'Network',
            description: 'Manta network name',
            value: 'manta',
          },
          {
            name: 'rawTx',
      ...
      },
      {
        ...
        description: 'Sign a Joystream transaction',
        parameters: [
          {
            name: 'path',
            type: 'string',
          ...
          },
          {
            ...
            required: true,
            label: 'Network',
            description: 'Joystream network name',
            value: 'joystream',
          },
          {
            name: 'rawTx',
