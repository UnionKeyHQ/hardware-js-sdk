...
How to handle PIN entry on UnionKey devices with recommended UX.
...
| --- | --- | --- |
| UnionKey Classic / 1s / 1s Pure / Mini | Supported | No |
| UnionKey Touch | Not supported | Yes |
| UnionKey Pro | Not supported | Yes |
