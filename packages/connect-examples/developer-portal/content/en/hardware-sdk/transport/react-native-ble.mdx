...
> **Note:**
Demo: React Native / Expo example → [react-native-demo](https://github.com/UnionKeyHQ/hardware-js-sdk/tree/develop/packages/connect-examples/react-native-demo)


This guide shows how to use the pure React Native BLE stack with `@unionkeyhq/hd-ble-sdk` and `@unionkeyhq/hd-transport-react-native`. No WebView or low-level adapter is required. The chain API usage stays the same as in Quick Start.
...
```bash
npm i @unionkeyhq/hd-ble-sdk @unionkeyhq/hd-transport-react-native \
      @unionkeyhq/react-native-ble-utils react-native-ble-plx \
...
- For additional examples, check: [react-native-demo](https://github.com/UnionKeyHQ/hardware-js-sdk/tree/onekey/packages/connect-examples/react-native-demo)

## Continue

- [Introduction](/en/hardware-sdk)
- [Error Code](/en/hardware-sdk/core-api-guide#error-codes), [Common Params](/en/hardware-sdk/core-api-guide#common-params)
- Protocol framing (64 bytes, for reference only): [See Low-Level Transport Plugin](/en/hardware-sdk/concepts/low-level-plugin#message-protocol-part-of-low-level-transport)
