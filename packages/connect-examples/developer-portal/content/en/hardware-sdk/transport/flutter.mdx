...
For Flutter apps that load a JS bundle via WebView or a JS engine and bridge to `@unionkeyhq/hd-common-connect-sdk` using a low-level adapter.
...
- Protocol framing: [See Low-Level Transport Plugin](/en/hardware-sdk/concepts/low-level-plugin#message-protocol-part-of-low-level-transport)
