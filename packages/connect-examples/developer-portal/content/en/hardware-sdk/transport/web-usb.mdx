...
Use this step‑by‑step guide to wire WebUSB in the browser with `@unionkeyfe/hd-common-connect-sdk`. Once connected, you can call any chain API (BTC/EVM/etc.) as in Quick Start.
...
```bash
npm i @unionkeyfe/hd-common-connect-sdk @unionkeyfe/hd-shared @unionkeyfe/hd-core
```
