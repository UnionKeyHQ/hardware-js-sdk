...
The UnionKey GUI provides the payload. The CLI imports the session into the local UnionKey CLI vault and uses the operating system credential store for protected material.
