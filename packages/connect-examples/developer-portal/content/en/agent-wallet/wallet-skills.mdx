...
[`unionkey-wallet-skills`](https://github.com/UnionKeyHQ/unionkey-wallet-skills) gives AI coding assistants a wallet capability layer. Users ask in natural language; the skills choose the safe route, inspect the live schema when needed, and explain results in user-facing language.
...
| Client | Install path |
| --- | --- |
| Claude Code | `/plugin marketplace add UnionKeyHQ/unionkey-wallet-skills`, then `/plugin install unionkey-wallet-skills` |
| Codex | Ask Codex to follow `https://raw.githubusercontent.com/UnionKeyHQ/unionkey-wallet-skills/main/.codex/INSTALL.md` |
| Cursor | Clone `https://github.com/UnionKeyHQ/unionkey-wallet-skills` and point Cursor at the plugin directory |
...
| --- | --- |
| `Connect my UnionKey Agent Wallet.` | Pair through App Transfer and summarize the active wallet. |
