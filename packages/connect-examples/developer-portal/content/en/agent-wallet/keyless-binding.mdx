...
Keyless binding is the product boundary that lets users manage an Agent Wallet in the UnionKey GUI without memorizing, exporting, or pasting private keys into an agent runtime.
...
| User need | UnionKey behavior |
| --- | --- |
| Create an automation wallet | Create and manage the Agent Wallet in UnionKey GUI. |
...
| --- | --- |
| UnionKey GUI | Create and manage the Agent Wallet and keyless account relationship |
