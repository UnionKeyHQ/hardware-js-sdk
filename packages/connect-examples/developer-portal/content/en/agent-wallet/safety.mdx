...
| Hardware-gated write | High-value transfer, sensitive contract call, hidden-wallet signing | Require UnionKey device confirmation and stop if the device rejects. |
