...
These examples show how a user can talk to an AI agent and what the UnionKey skill should do behind the scenes.
...
```text
Use my UnionKey hardware wallet to send 50 USDC to 0x...
```
