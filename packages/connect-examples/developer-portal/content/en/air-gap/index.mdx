...
If you are integrating UnionKey Air-Gap into an existing wallet, you need to ensure your QR scanner routes these UR types to a **BC-UR v2 decoder** (fountain-coded), not a legacy v1 decoder.
...
The `onekey-app-call-device` UR type is a **UnionKey-internal protocol** used for device management operations (e.g., `getMultiAccounts`, `verifyAddress`). Third-party wallets **should NOT implement this type** — it may change without notice. Use the standard Keystone SDK methods instead.

## Demo & Examples

- **React Native Demo**: [GitHub Air-Gap Demo](https://github.com/UnionKeyHQ/hardware-js-sdk/tree/onekey/packages/connect-examples/react-native-demo/air-gap)
  - Scanner: [AirGapScanner.tsx](https://github.com/UnionKeyHQ/hardware-js-sdk/blob/onekey/packages/connect-examples/react-native-demo/air-gap/src/components/AirGapScanner.tsx)
  - Chain helpers: [sdk/](https://github.com/UnionKeyHQ/hardware-js-sdk/tree/onekey/packages/connect-examples/react-native-demo/air-gap/sdk)
