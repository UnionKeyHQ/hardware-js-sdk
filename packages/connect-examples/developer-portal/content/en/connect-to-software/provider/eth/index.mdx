---
title: Ethereum / EVM
description: Ethereum & EVM integration with UnionKey's injected EIP-1193 provider
---
...
Use the injected EIP-1193 provider to build EVM dApps with UnionKey. All EVM-compatible chains (Ethereum, Polygon, BSC, Arbitrum, Optimism, Base, etc.) share the same provider.
...
if (!provider) throw new Error('UnionKey not detected')
