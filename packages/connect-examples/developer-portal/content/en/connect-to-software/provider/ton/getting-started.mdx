...
description: Connect to TON using UnionKey's TON Connect compatible provider
---
...
Learn how to detect, connect, and interact with TON using UnionKey's provider.
