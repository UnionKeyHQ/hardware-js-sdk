...
Once a transaction is created, the web application may ask the user's UnionKey wallet to sign and send the transaction using their account's private key and NEAR JSON RPC connection.&#x20;
