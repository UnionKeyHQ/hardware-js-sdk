...
When the web application is connected to UnionKey, it can also request that the user signs a given message.&#x20;

In order to send a message for the user to sign, the web application must:&#x20;

* Provide UTF-8 encoded string.
* Have it be signed by the user's UnionKey Wallet.
