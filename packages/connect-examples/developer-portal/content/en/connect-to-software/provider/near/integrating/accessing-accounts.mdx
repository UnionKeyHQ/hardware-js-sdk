...
After wallet connection established, you can access the accounts connected with the UnionKey wallet.&#x20;

User accounts are used in a variety of contexts in UnionKey, including as identifiers and for signing transactions.
