...
Although, we strongly recommend using formal API to interact your applicactions with UnionKey Wallet, we still provide some legacy API that is very similar to [Near Web Wallet](https://wallet.near.org/), make it easier for you migrating existing codes from Near Web Wallet.
