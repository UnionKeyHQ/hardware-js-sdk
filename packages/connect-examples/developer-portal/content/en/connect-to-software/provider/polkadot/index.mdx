---
title: Polkadot
description: Polkadot integration via UnionKey's Polkadot.js-compatible provider
---
...
Integrate Polkadot and Substrate-based chains using UnionKey's provider. Access via `window.$onekey.polkadot` or the Polkadot.js extension API.

<Callout type="info">
UnionKey implements the Polkadot.js extension interface, ensuring compatibility with all Substrate dApps.
</Callout>
...
```typescript
// UnionKey registers as a Polkadot.js extension
...
```typescript
// Using UnionKey provider directly
...
// Enable all extensions (including UnionKey)
