---
title: Web3-Onboard
description: Integrate UnionKey with Blocknative's Web3-Onboard
---
...
<Callout type="info">
UnionKey is automatically detected via the injected wallets module. No additional configuration required.
</Callout>
