...
description: Integrate UnionKey with Aptos Wallet Adapter for React dApps
---
...
Official Aptos wallet connection library for React. UnionKey is automatically detected via Wallet Standard, no additional configuration required.

<Callout type="info">
UnionKey is automatically detected by the Aptos Wallet Adapter. The wallet will appear in the connection modal without any extra setup.
</Callout>
