...
使用指定 BIP32 路径派生的私钥对交易进行签名。用户需要在 UnionKey 上确认所有交易详情。
...
* `inputs` - _必需_ [KaspaSignInputParams](https://github.com/UnionKeyHQ/hardware-js-sdk/blob/269ee367141ae2186a9a63d1d89e9f4c70428623/packages/core/src/types/api/kaspaSignTransaction.ts#L9C1-L19C3) 的 `Array`。
* `outputs` - _必需_ [KaspaSignOutputParams](https://github.com/UnionKeyHQ/hardware-js-sdk/blob/269ee367141ae2186a9a63d1d89e9f4c70428623/packages/core/src/types/api/kaspaSignTransaction.ts#L21C1-L26C1) 的 `Array`。
