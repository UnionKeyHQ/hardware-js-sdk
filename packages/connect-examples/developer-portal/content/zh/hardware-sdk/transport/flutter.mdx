...
适用于通过 WebView 或 JS 引擎加载 JS 包并使用底层适配器桥接到 `@unionkeyhq/hd-common-connect-sdk` 的 Flutter 应用。
...
- 协议帧：[见底层传输插件](/zh/hardware-sdk/concepts/low-level-plugin#消息协议包含在底层传输中)
- UI 事件：[事件配置](/zh/hardware-sdk/core-api-guide#events-ui)，[PIN](/zh/hardware-sdk/concepts/pin)，[Passphrase](/zh/hardware-sdk/concepts/passphrase)
- 平台详情：[iOS 蓝牙](/zh/hardware-sdk/transport/ios)，[Android 蓝牙](/zh/hardware-sdk/transport/android)
