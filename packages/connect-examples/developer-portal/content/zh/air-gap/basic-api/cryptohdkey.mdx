...
| `key` | `Buffer` | 密钥数据 |
| `chainCode` | `Buffer` | 链码 |
| `useInfo` | [`CryptoCoinInfo`](/zh/air-gap/basic-api/cryptocoininfo) | 使用信息 |
| `origin` | [`CryptoKeypath`](/zh/air-gap/basic-api/cryptokeypath) | 原始路径 |
| `children` | [`CryptoKeypath`](/zh/air-gap/basic-api/cryptokeypath) | 子路径 |
