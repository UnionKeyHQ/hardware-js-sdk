---
title: 快速开始
description: 使用 UnionKey 的 CIP-30 兼容 Provider 连接 Cardano
---
...
<Callout type="info">
UnionKey 实现了 CIP-30（Cardano dApp 连接器），确保与所有 Cardano dApp 兼容。它还提供 Nami 钱包兼容性。
</Callout>
...
```typescript
// UnionKey 同时提供 onekey 和 nami 接口
