...
description: 在 React dApp 中集成 UnionKey 与 Aptos Wallet Adapter
---
...
Aptos 官方的 React 钱包连接库。UnionKey 通过 Wallet Standard 自动被检测，无需额外配置。

<Callout type="info">
UnionKey 会被 Aptos Wallet Adapter 自动检测。钱包会直接出现在连接弹窗中，无需额外设置。
</Callout>
