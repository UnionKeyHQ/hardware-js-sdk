import { UI_REQUEST, UI_RESPONSE, serializeConnectorError } from '@unionkeyhq/hwk-adapter-core';

import { LedgerAdapter } from '../adapter/LedgerAdapter';

import type { ConnectorDevice, ConnectorSession, IConnector } from '@unionkeyhq/hwk-adapter-core';
