...
Hardware-js-sdk is designed to allow third-party developers to quickly access the UnionKey hardware wallet. The repository structure uses the monorepo to make each module more manageable.
...
See the full documentation on [developer.unionkey.io](https://developer.unionkey.io/connect-to-hardware/hardware-sdk).

## hardware-js-sdk development

Before you start make sure you have downloaded and installed NVM, Yarn and git with git lfs.

- `git clone git@github.com:UnionKeyHQ/hardware-js-sdk.git`
